...
package STM32_SVD.RCC is
   ...
   subtype PLLCFGR_PLLM_Element is STM32_SVD.Bit;
   ...
   subtype PLLCFGR_PLLN_Element is STM32_SVD.Bit;
   ...
   subtype PLLCFGR_PLLP_Element is STM32_SVD.Bit;
   ...
   subtype PLLCFGR_PLLQ_Element is STM32_SVD.Bit;
   ...
   subtype CFGR_SW_Element is STM32_SVD.Bit;
   ...
   subtype CFGR_SWS_Element is STM32_SVD.Bit;
   ...
   type APB1RSTR_Register is record
      ...
      --  unspecified
      Reserved_4_10  : STM32_SVD.UInt7 := 16#0#;
   ...
   type AHB1ENR_Register is record
      ...
      --  unspecified
      Reserved_13_20 : STM32_SVD.Byte := 16#80#;
      --  DMA1 clock enable
   ...
   subtype APB2ENR_SPI4EN_Field is STM32_SVD.Bit;
   ...
   type AHB1LPENR_Register is record
      ...
      --  unspecified
      Reserved_5_6   : STM32_SVD.UInt2 := 16#3#;
      --  IO port H clock enable during Sleep mode
      GPIOHLPEN      : AHB1LPENR_GPIOHLPEN_Field := 16#1#;
      --  unspecified
      Reserved_8_11  : STM32_SVD.UInt4 := 16#1#;
   ...
   type AHB2LPENR_Register is record
      --  unspecified
      Reserved_0_6  : STM32_SVD.UInt7 := 16#71#;
   ...
   type APB1LPENR_Register is record
      ...
      --  unspecified
      Reserved_4_10  : STM32_SVD.UInt7 := 16#1F#;
      ...
      --  unspecified
      Reserved_18_20 : STM32_SVD.UInt3 := 16#7#;
      ...
      --  unspecified
      Reserved_24_27 : STM32_SVD.UInt4 := 16#6#;
   ...
   type APB2LPENR_Register is record
      ...
      --  unspecified
      Reserved_1_3   : STM32_SVD.UInt3 := 16#1#;
      ...
      --  unspecified
      Reserved_9_10  : STM32_SVD.UInt2 := 16#3#;

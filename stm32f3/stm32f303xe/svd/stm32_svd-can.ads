...
package STM32_SVD.CAN is
   ...
   type BTR_Register is record
      ...
      --  TS1
      TS1            : BTR_TS1_Field := 16#3#;
      --  TS2
      TS2            : BTR_TS2_Field := 16#2#;
      --  unspecified
      Reserved_23_23 : STM32_SVD.Bit := 16#0#;
      --  SJW
      SJW            : BTR_SJW_Field := 16#1#;
      --  unspecified
   ...
   subtype TDT0R_TIME_Field is STM32_SVD.UInt16;
   ...
   subtype TDT1R_TIME_Field is STM32_SVD.UInt16;
   ...
   subtype TDT2R_TIME_Field is STM32_SVD.UInt16;
   ...
   subtype RDT0R_TIME_Field is STM32_SVD.UInt16;
   ...
   subtype RDT1R_TIME_Field is STM32_SVD.UInt16;

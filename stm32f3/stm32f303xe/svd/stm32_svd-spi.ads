...
package STM32_SVD.SPI is
   ...
   subtype CR2_NSSP_Field is STM32_SVD.Bit;
   ...
   subtype CR2_DS_Field is STM32_SVD.UInt4;
   subtype CR2_FRXTH_Field is STM32_SVD.Bit;
   subtype CR2_LDMA_RX_Field is STM32_SVD.Bit;
   subtype CR2_LDMA_TX_Field is STM32_SVD.Bit;
   ...
   subtype SR_FRLVL_Field is STM32_SVD.UInt2;
   subtype SR_FTLVL_Field is STM32_SVD.UInt2;

...
package body STM32GD.GPIO.Pin is
   ...
   begin
      case Port is
         ...
         when Port_E => RCC_Periph.AHBENR.IOPEEN := 1;
   ...
   begin
      case Port is
         ...
         when Port_E => RCC_Periph.AHBENR.IOPEEN := 0;
   ...
   begin
      EXTI_Periph.PR1.PR.Arr (Index) := 1;
      case Index is
   ...
   begin
      return EXTI_Periph.PR1.PR.Arr (Index) = 1;
   end Triggered;
   ...
   begin
      ...
      if Rising then
         EXTI_Periph.RTSR1.TR.Arr (Index) := 1;
      end if;
      if Falling then
         EXTI_Periph.FTSR1.TR.Arr (Index) := 1;
      end if;

...
package STM32_SVD.SYSCFG is
   ...
   subtype CFGR2_CAPA_Field is STM32_SVD.UInt3;
   ...
   subtype COMP1_CTRL_COMP1EN_Field is STM32_SVD.Bit;
   subtype COMP1_CTRL_COMP1INNSEL_Field is STM32_SVD.UInt2;
   subtype COMP1_CTRL_COMP1WM_Field is STM32_SVD.Bit;
   subtype COMP1_CTRL_COMP1LPTIMIN1_Field is STM32_SVD.Bit;
   subtype COMP1_CTRL_COMP1POLARITY_Field is STM32_SVD.Bit;
   subtype COMP1_CTRL_COMP1VALUE_Field is STM32_SVD.Bit;
   subtype COMP1_CTRL_COMP1LOCK_Field is STM32_SVD.Bit;
   ...
   subtype COMP2_CTRL_COMP2EN_Field is STM32_SVD.Bit;
   subtype COMP2_CTRL_COMP2SPEED_Field is STM32_SVD.Bit;
   subtype COMP2_CTRL_COMP2INNSEL_Field is STM32_SVD.UInt3;
   subtype COMP2_CTRL_COMP2INPSEL_Field is STM32_SVD.UInt3;
   subtype COMP2_CTRL_COMP2LPTIMIN2_Field is STM32_SVD.Bit;
   subtype COMP2_CTRL_COMP2LPTIMIN1_Field is STM32_SVD.Bit;
   subtype COMP2_CTRL_COMP2POLARITY_Field is STM32_SVD.Bit;
   subtype COMP2_CTRL_COMP2VALUE_Field is STM32_SVD.Bit;
   subtype COMP2_CTRL_COMP2LOCK_Field is STM32_SVD.Bit;

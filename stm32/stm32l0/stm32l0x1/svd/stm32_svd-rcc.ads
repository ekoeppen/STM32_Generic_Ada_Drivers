...
package STM32_SVD.RCC is
   ...
   subtype CFGR_MCOSEL_Field is STM32_SVD.UInt3;
   ...
   subtype APB2RSTR_TIM22RST_Field is STM32_SVD.Bit;
   ...
   subtype APB1RSTR_CRCRST_Field is STM32_SVD.Bit;
   subtype APB1RSTR_PWRRST_Field is STM32_SVD.Bit;
   subtype APB1RSTR_I2C3_Field is STM32_SVD.Bit;
   ...
   type APB1RSTR_Register is record
      ...
      --  unspecified
      Reserved_23_26 : STM32_SVD.UInt4 := 16#0#;
      --  CRC reset
   ...
   subtype APB2ENR_FWEN_Field is STM32_SVD.Bit;
   ...
   subtype AHBSMENR_CRYPTSMEN_Field is STM32_SVD.Bit;
   ...
   type AHBSMENR_Register is record
      ...
      --  unspecified
      Reserved_13_23 : STM32_SVD.UInt11 := 16#88#;
   ...
   type APB1SMENR_Register is record
      ...
      --  unspecified
      Reserved_23_26 : STM32_SVD.UInt4 := 16#1#;
      ...
      --  unspecified
      Reserved_29_29 : STM32_SVD.Bit := 16#1#;
   ...
   subtype CCIPR_I2C3SEL_Element is STM32_SVD.Bit;
   ...
   subtype CSR_LSIIWDGLP_Field is STM32_SVD.Bit;
   ...
   subtype CSR_FWRSTF_Field is STM32_SVD.Bit;

...
package STM32GD.Board is
   ...
   package LED_RED     is new GPIO.Pin (Pin => GPIO.Pin_1, Port => GPIO.Port_A, Mode => GPIO.Mode_Out);
   package LED_GREEN   is new GPIO.Pin (Pin => GPIO.Pin_0, Port => GPIO.Port_F, Mode => GPIO.Mode_Out);

...
package STM32GD.Board is
   ...
   package CE        is new STM32GD.GPIO (Pin => 1, Port => GPIOB_Periph, Output => True);
   ...
   package USART     is new STM32GD.USART (USART => USART2_Periph, Speed => 115200, Clock_Tree => CLOCKS, Clock => STM32GD.Clock.PCLK1);
